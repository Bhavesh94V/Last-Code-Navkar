  ...
  const testimonials = [
    {
      ...
      rating: 5,
      testimonial: "Navkar Bhavsar & Co. has been instrumental in our company's financial success. Their strategic tax planning saved us significant costs while ensuring complete compliance.",
    ...
    },
    {
      ...
      rating: 5,
      testimonial: "The audit services provided by the team are thorough and professional. They helped us streamline our financial processes and improve operational efficiency.",
      image: "/api/placeholder/80/80"
    },
    {
      name: "Amit Patel",
      ...
      rating: 5,
      testimonial: "Excellent business advisory services! They guided us through complex regulatory requirements and helped us expand our operations successfully.",
      image: "/api/placeholder/80/80"
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <div className="animate-on-scroll">
            <span className="text-muted-foreground font-semibold text-lg">Our Clients</span>
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-foreground mt-4 mb-6">
              Trusted by Leading Businesses
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We're proud to serve diverse businesses across industries, 
        ...
        <div className="mb-20">
          <div className="animate-on-scroll text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our expertise spans across multiple industries, enabling us to provide 
              specialized solutions for unique sector requirements.
            </p>
          </div>
        ...
        <div className="animate-on-scroll text-center">
          <div className="bg-gradient-primary rounded-2xl p-12 text-white">
            ...
            <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
              Experience the difference of working with a trusted chartered accountancy firm. 
