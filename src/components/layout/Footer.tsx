...
const Footer = () => {
  ...
  const services = [
    ...
    { title: "Audit Services", href: "/services/audit" },
    { title: "Business Advisory", href: "/services/advisory" },
    { title: "Company Registration", href: "/services/registration" },
    { title: "GST Services", href: "/services/gst" }
  ];
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-accent rounded-lg flex items-center justify-center">
                <span className="text-accent-foreground font-bold text-xl font-serif">B</span>
              </div>
              <div>
                <h3 className="text-xl font-serif font-bold">Bihari Shah & Co.</h3>
            ...
            <p className="text-primary-foreground/80 leading-relaxed mb-6">
              ...
              Over 25 years of excellence in chartered accountancy services.
            </p>
