        ...
        <div className='container mx-auto px-6'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl text-white/90 leading-relaxed'>
              Get in touch with our professional team. We're here to help you
              succeed.
            </p>
          </div>
        </div>
            ...
            <div>
              ...
              <div className='mt-8 p-6 bg-gradient-accent rounded-xl text-accent-foreground'>
                ...
                <p className='text-sm mb-4'>
                  For urgent tax compliance or audit matters, our emergency
        ...
        <div className='container mx-auto px-6'>
          <div className='text-center mb-12'>
            ...
            <p className='text-sm text-muted-foreground mt-2'>
              VRAJ VALENCIA, 4th Floor 408-411, Behind Mahindra Showroom, Near
              Sola Flyover, S. G. Highway, Ahmedabad - 380060
            </p>
          </div>
